...
public class Level3 extends JFrame implements KeyListener {
	...
	Icon yellow = new ImageIcon(getClass().getResource("yellow.png"));
	Icon black = new ImageIcon(getClass().getResource("black.png"));
	...
	public Level3(int input) {
		
		super("Arkanoid Game - Level 3");
		...
		for(i=0; i<row*column; i++){
			if(i == 0) {
				...
				myLabels[i] = new JLabel("LEVEL 3", JLabel.CENTER);
				...
				myLabels[i] = new JLabel(yellow);  // Add 27 Red images To Labels		
			}
			else if(i < 67 && i >= 56 ) {
				myLabels[i] = new JLabel(black);  // Add 27 Red images To Labels		
			}
			else {
			...
			if(up) {
				if(left) {
					if(iconEmpty.equals(myLabels[(yBall-1)*column+xBall].getIcon()) && iconEmpty.equals(myLabels[((yBall-1)*column+(xBall-1))].getIcon())) {
						...
						if(black.equals(myLabels[(yBall-1)*column+xBall].getIcon())) {
							myLabels[(yBall-1)*column+xBall].setIcon(yellow);
							myLabels[yBall*column+xBall].setIcon(iconEmpty);
							yBall++;
							xBall--;
							myLabels[yBall*column+xBall].setIcon(ball);
						...
						else if(yellow.equals(myLabels[(yBall-1)*column+xBall].getIcon())) {
							myLabels[(yBall-1)*column+xBall].setIcon(red);
							myLabels[yBall*column+xBall].setIcon(iconEmpty);
							yBall++;
							xBall--;
							myLabels[yBall*column+xBall].setIcon(ball);
						...
						if(black.equals(myLabels[yBall*column+(xBall-1)].getIcon())) {
							myLabels[yBall*column+(xBall-1)].setIcon(yellow);
							myLabels[yBall*column+xBall].setIcon(iconEmpty);
							yBall++;
							xBall++;
							myLabels[yBall*column+xBall].setIcon(ball);
						...
						else if(yellow.equals(myLabels[yBall*column+(xBall-1)].getIcon())) {
							myLabels[yBall*column+(xBall-1)].setIcon(red);
							myLabels[yBall*column+xBall].setIcon(iconEmpty);
							yBall++;
							xBall++;
							myLabels[yBall*column+xBall].setIcon(ball);
						...
						if(black.equals(myLabels[(yBall-1)*column+(xBall-1)].getIcon())) {
							myLabels[(yBall-1)*column+(xBall-1)].setIcon(yellow);
							myLabels[yBall*column+xBall].setIcon(iconEmpty);
							yBall++;
							xBall++;
							myLabels[yBall*column+xBall].setIcon(ball);
						...
						else if(yellow.equals(myLabels[(yBall-1)*column+(xBall-1)].getIcon())) {
							myLabels[(yBall-1)*column+(xBall-1)].setIcon(red);
							myLabels[yBall*column+xBall].setIcon(iconEmpty);
							yBall++;
							xBall++;
							myLabels[yBall*column+xBall].setIcon(ball);
